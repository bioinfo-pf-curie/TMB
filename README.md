...
Of note, you can also direclty install pyTMB from the `bioconda` channel as any other packages:

```
conda install -c bioconda -c conda-forge tmb=1.3.0 -n pytmb
```
...
```
bcftools norm -f FASTA -o file_norm.vcf file
```
